...
/// Общий маппинг ISO 3166-1 alpha-3 ↔ alpha-2 (ключ прогресса обучения в GameState — alpha-3).
enum ISO3166 {
    ...
    static let alpha2ToAlpha3: [String: String] = {
        ...
        inv.reserveCapacity(alpha3ToAlpha2.count)
        for (a3, a2) in alpha3ToAlpha2 {
            if inv[a2] == nil { inv[a2] = a3 }
        }
        return inv
    }()
}
